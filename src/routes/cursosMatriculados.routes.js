...
const router = Router();
import { getCursosMatriculados, getCursoMatriculado, insertCursoMatriculado, updateCursoMatriculado, agregarNota, deleteCursoMatriculado } from "../controllers/cursosMatriculados.controller";
